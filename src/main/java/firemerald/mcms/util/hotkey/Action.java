...
public class Action
{
	...
	public static final Action CLONE_TEXTURE = new Action("clone_texture", "Clone the active texture", "Clone texture", CHECK_TEXTURE, () -> {
		Project project = Main.instance.project;
	...
	public static final Action REMOVE_TEXTURE = new Action("remove_texture", "Remove the active texture", "Remove texture", CHECK_TEXTURE, () -> {
		final String name = Main.instance.project.getTextureName();
