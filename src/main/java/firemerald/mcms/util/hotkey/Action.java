...
public class Action
{
	...
	public static final Action NEW_MODEL = new Action("new_model", "add a new model", () -> new GuiPopupModel(false).activate(), null);
	public static final Action ADD_MODEL = new Action("add_model", "add a new model from an OBJ model", () -> new GuiPopupAddModel().activate(), null);
	public static final Action LOAD_MODEL = new Action("load_model", "load mesh components from an OBJ model to the active model", CHECK_MODEL, () -> new GuiPopupLoadModel().activate(), null);
	public static final Action CLONE_MODEL = new Action("clone_model", "Create a copy of the active model", CHECK_MODEL, () -> {
	...
	public static final Action EXPORT_MODEL = new Action("export_model", "Export the active model to an OBJ file using it's current pose", CHECK_MODEL, () -> {
	...
	public static final Action EXPORT_UNPOSED_MODEL = new Action("export_unposed_model", "Export the active model to an OBJ file without any pose data", CHECK_MODEL, () -> {
		File file = FileUtils.getSaveFile("obj", "");
		if (file != null)
		{
			Writer writer = null;
	...
	public static final Action EDIT_MODEL = new Action("edit_model", "Edit the active model's properties", CHECK_MODEL, () -> new GuiPopupModel(true).activate(), null);
	public static final Action REMOVE_MODEL = new Action("remove_model", "Remove the active model", CHECK_MODEL, () -> {
	...
	public static final Action IMPORT_SKELETON = new Action("import_skeleton", "Import a skeleton to the active model or skeleton", CHECK_RIG, () -> {
	...
	public static final Action EXPORT_SKELETON = new Action("exports_skeleton", "Export the skeleton of the active model or skeleton", CHECK_RIG, () -> {
	...
	public static final Action NEW_TEXTURE = new Action("new_texture", "Add a new texture", () -> new GuiPopupNewTexture().activate(), null);
	public static final Action ADD_TEXTURE = new Action("add_texture", "Add a new texture from a file", () -> new GuiPopupLoadTexture().activate(), null);
	...
	public static final Action EDIT_TEXTURE = new Action("edit_texture", "Edit the active texture", CHECK_TEXTURE, () -> new GuiPopupEditTexture().activate(), null);
	...
	public static final Action NEW_ANIMATION = new Action("new_animation", "Add a new animation", () -> new GuiPopupNewAnimation().activate(), null);
	public static final Action ADD_ANIMATION = new Action("add_animation", "Add a new animation from a file", () -> new GuiPopupLoadAnimation().activate(), null); //TODO scale?
	...
	public static final Action EDIT_ANIMATION = new Action("edit_animation", "Edit the active animation", CHECK_ANIMATION, () -> new GuiPopupEditAnimation().activate(), null);
