...
public class GuiPopupNewProject extends GuiPopup
{
	...
	public GuiPopupNewProject()
	{
		...
		int y = cy;
		this.addElement(name = new ComponentText(cx, y, cx + cw, y + 20, Main.instance.fontMsg, "Untitled", text -> {}));
		y += 20;
		this.addElement(labelWidth = new ComponentFloatingLabel(cx, y, cx + cw - 70, y + 20, Main.instance.fontMsg, "texture width"));
		this.addElement(width = new ComponentTextInt(cx + cw - 70, y, cx + cw - 10, y + 20, Main.instance.fontMsg, 64, 1, Integer.MAX_VALUE));
		...
		this.addElement(height = new ComponentTextInt(cx + cw - 70, y, cx + cw - 10, y + 20, Main.instance.fontMsg, 64, 1, Integer.MAX_VALUE));
		...
		this.addElement(scale = new ComponentTextFloat(cx + cw - 70, y, cx + cw - 10, y + 20, Main.instance.fontMsg, 16, Float.MIN_VALUE, Float.MAX_VALUE));
