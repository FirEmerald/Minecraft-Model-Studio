...
public class ComponentColorPicker extends ComponentPane
{
	...
	private static final class ColorModeTab
	{
		...
		final String iconTex;
		ThemeElement element;
		final boolean connectLeft, connectRight;
		
		ColorModeTab(ComponentPaneColorPicker picker, String iconTex, Mesh iconMesh, Mesh tabMesh, boolean connectLeft, boolean connectRight)
		{
			this.picker = picker;
	...
	public ComponentColorPicker(int x, int y, ColorModel color, Consumer<ColorModel> onColor)
	{
		...
		this.color = color;
		orderedTabs.add(new ColorModeTab(new ComponentPaneRGB(12, 60, 228, 215, color), "color_pickers/rgb_icon.png", ICON_RGB, TAB_RGB, false, true));
		orderedTabs.add(new ColorModeTab(new ComponentPaneHSV(12, 60, 228, 215, color), "color_pickers/hsv_icon.png", ICON_HSV, TAB_HSV, true, true));
		orderedTabs.add(new ColorModeTab(new ComponentPaneHSL(12, 60, 228, 215, color), "color_pickers/hsl_icon.png", ICON_HSL, TAB_HSL, true, true));
