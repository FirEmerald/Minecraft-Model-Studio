...
public class GuiPopupEditAnimation extends GuiPopup
{
	...
	public GuiPopupEditAnimation()
	{
		...
		this.addElement(length = new ComponentTextFloat(cx + 50, y, cx + cw - 10, y + 20, Main.instance.fontMsg, anim.getLength(), Float.MIN_VALUE, Float.MAX_VALUE));
		...
		this.addElement(loop = new ComponentToggle(cx + 35, y + 5, cx + 45, y + 15, anim.loop, null));
	...
	public void apply()
	{
		...
		anim.setRelative(relative.state);
