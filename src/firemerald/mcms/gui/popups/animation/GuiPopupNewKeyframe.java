...
public class GuiPopupNewKeyframe extends GuiPopup
{
	...
	public GuiPopupNewKeyframe(ComponentFramesBar framesBar)
	{
		...
		this.addElement(nameOptions = new DropdownButton(cx + cw - 20, y, cx + cw, y + 20, name.x1, name.y1, name.x2, name.y2, names, (ind, val) -> name.setText(val)));
		y += 20;
	...
	public void setSize(int w, int h)
	{
		...
		nameOptions.setSize(cx + cw - 20, y, cx + cw, y + 20, name.x1, name.y1, name.x2, name.y2);
		y += 20;
