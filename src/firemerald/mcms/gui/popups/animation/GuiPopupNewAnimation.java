...
public class GuiPopupNewAnimation extends GuiPopup
{
	...
	public GuiPopupNewAnimation()
	{
		...
		this.addElement(length = new ComponentTextFloat(cx + 50, y, cx + cw - 10, y + 20, Main.instance.fontMsg, 5, Float.MIN_VALUE, Float.MAX_VALUE));
	...
	public void apply()
	{
		...
		project.addAnimation(name, new Animation(length.getVal(), loop.state, relative.state));
		deactivate();
	}
}