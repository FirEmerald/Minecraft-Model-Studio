...
public class PlaybackEndButton extends PlaybackButton
{
	...
	public boolean isEnabled()
	{
		...
		return main.project.getAnimation() != null && main.animTime < main.project.getAnimation().getLength();
	}
	...
	public void onRelease()
	{
		...
		Main.instance.animTime = Main.instance.project.getAnimation().getLength();
	}
}